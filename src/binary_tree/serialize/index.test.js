...
test('deserialize binary tree', () => {
  const deserialized = deserialize([1,2,3,null,null,4,null,null,5,null,null])
...
test('serialize binary tree', () => {
  const serialized = serialize(deserialize([1,2,3,null,null,4,null,null,5,null,null]))
  expect(serialized).toEqual([1,2,3,null,null,4,null,null,5,null,null])
})